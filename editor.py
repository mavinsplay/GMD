...
class Redactor:
    def __init__(self, size):
        ...
        self.player1 = Player((210, 210), all_sprites)
        self.player = Player((920, 300), all_sprites)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                    if event.pos[0] < 900:
                        ...
                        if click:
                            if self.posit == 0:
                                Stone((event.pos[0] - event.pos[0] %
                                      30, event.pos[1] - event.pos[1] % 30))
                            elif self.posit == 1:
                                Stone(
                                    (event.pos[0] - event.pos[0] % 30, event.pos[1] - event.pos[1] % 30), True)
                            elif self.posit == 2:
        ...
        all_sprites.remove(self.player, self.stone,
                           self.trap, self.screen, self.screen1)
        self.save(1) # !!!!
